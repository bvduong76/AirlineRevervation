...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post passengers_url, params: { passenger: { booking: @passenger.booking, firstname: @passenger.firstname, lastname: @passenger.lastname, title: @passenger.title } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { booking: @passenger.booking, firstname: @passenger.firstname, lastname: @passenger.lastname, title: @passenger.title } }
